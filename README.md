...
- **Data object reference** — User, Chat Message, Viewer Metrics
- **Glossary** — key terms used across the webhook system

Start here: [`Writerside/topics/Owncast-Documentation.md`](Writerside/topics/Owncast-Documentation.md)

## About

These documents are not part of the official Owncast documentation. They were independently written to demonstrate technical writing skills: API reference writing, system architecture documentation, and docs-as-code workflows.
